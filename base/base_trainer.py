        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            if self.mnt_mode != 'off':
                try:
                    ...
                    improved = (log['metrics_sum'])>=self.mnt_best
                    # improved = (log['val_0_t2v_metrics_geometric_mean_R1-R5-R10'] + log['val_0_v2t_metrics_geometric_mean_R1-R5-R10'])>=self.mnt_best
                except KeyError:
                ...
                if improved:
                    ...
                    self.mnt_best = log['metrics_sum']
                    # self.mnt_best = log['val_0_t2v_metrics_geometric_mean_R1-R5-R10'] + log['val_0_v2t_metrics_geometric_mean_R1-R5-R10']
                    not_improved_count = 0
                    best = True
                else:
